	...
	// =========================================Variables=================================================================================
	   ...
	   // String expurl="https://sunnetqa.anblicks.com/itoa/login.htmlx";
		...
		public void datetypdDb() throws ClassNotFoundException, SQLException {
				...
				try { 
					 System.out.println("started executig the script in list page");
					...
					String query = "select count(*) from toa_projects";	
					Statement stmt = con.createStatement();					

					// Execute the SQL Query. Store results in ResultSet		
						ResultSet rs= stmt.executeQuery(query);							
						// While Loop to iterate through all data and print results	
 						System.out.println(rs.getFetchSize()+" all in range count");
